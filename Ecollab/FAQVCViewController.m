...
- (void)viewDidLoad {
    ...
    myAccountDataArray = [[NSMutableArray alloc] initWithObjects:@"1. How do I create my account?",@"2. I forgot my password. How can I login?",@"3. Can I change my password?",@"4. How to tell my friend about the app?",@"5. How can I change my user name?", nil];
